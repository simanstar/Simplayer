/****************************************************************************
** Meta object code from reading C++ file 'SimPlayer.h'
**
...
#error "The header file 'SimPlayer.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_SimPlayer_t {
    QByteArrayData data[7];
    char stringdata[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_SimPlayer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_SimPlayer_t qt_meta_stringdata_SimPlayer = {
    {
...
QT_MOC_LITERAL(6, 45, 5)
    ...
    "SimPlayer\0display\0\0UpdateTime\0setState\0"
    "State\0state\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_SimPlayer[] = {
...
void SimPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SimPlayer *_t = static_cast<SimPlayer *>(_o);
        switch (_id) {
        ...
        {
            typedef void (SimPlayer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SimPlayer::display)) {
                *result = 0;
            }
        }
        {
            typedef void (SimPlayer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SimPlayer::UpdateTime)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject SimPlayer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SimPlayer.data,
      qt_meta_data_SimPlayer,  qt_static_metacall, 0, 0}
};


const QMetaObject *SimPlayer::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *SimPlayer::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SimPlayer.stringdata))
        return static_cast<void*>(const_cast< SimPlayer*>(this));
    if (!strcmp(_clname, "BaseConstant"))
        return static_cast< BaseConstant*>(const_cast< SimPlayer*>(this));
    return QThread::qt_metacast(_clname);
}

int SimPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void SimPlayer::display()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void SimPlayer::UpdateTime()
{
...
void DecodeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DecodeThread::UpdateTime)) {
                *result = 0;
            }
        }
    }
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoThread::UpdateTime)) {
                *result = 0;
            }
        }
    }
